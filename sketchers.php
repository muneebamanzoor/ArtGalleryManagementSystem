...
require_once ('php/CreateDbsketcher.php');
require_once ('./php/componentsketcher.php');


// create instance of Createdb class
$database = new CreateDbsketcher("art", "Producttbsketcher");
if (isset($_POST['add'])){
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item dropdown down1">
                            ...
                            <div class="dropdown-menu menu1" aria-labelledby="navbarDropdown" style="margin-top:40px;">
                                ...
                                <a class="dropdown-item item4" href="abtract.php" >Sketchers</a>
                        ...
                        <li class="nav-item">
                        <form action="php/cartsketchers.php">
